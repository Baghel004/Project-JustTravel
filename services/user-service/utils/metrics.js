// Prometheus instrumentation for the user-service. Each service ships its own copy so
// they stay independent; the `service` label lets Grafana tell them apart.

const client = require('prom-client');

const register = new client.Registry();
register.setDefaultLabels({ app: 'wanderlust', service: 'user-service' });
